...
- 2017: Adelaide Crows. Runner up: Brisbane Lions. 
- 2018: Western Bulldogs. Runner up: Brisbane Lions.
...
- No, not necessarily. 
- 100% dispatch?
2017: Kim Nickle; Natalie Plane.
2018: Sarah Lampard. 
- 0% dispatch?
2017: Hannah Dun; Lou Wotton; Romy Timmins; Taryn Priestly.
...
- 1.5 goals; Katie Breman; yes, different.
...
- Scatter plot remains fairly consistent from 2017-18.
...
- Yes, there could be a possible mistake. In both years, Emma Kearney scored higher average kicks and in 2018, higher average goals additionally.
...
- Change the variables being combined to make the low-dimensional picture. Does the plot change? Explain why this happens based on the formulae given in the lecture notes.
      a. Yes, the plot changes. As the number and type of variable are changed, the numbers entered into the function that generates the Euclidian distance between points changes, and so the output of the function changes also. When all the outputs change, the plot must change also, and this is observed in the recalibration of plots.
- Color the points by teams. Is there much difference between teams? If so, or if not, what does this mean?
      a. There is little difference between teams. This implies little variation between teams as whole. 
- Find the most valuable player awardee in each year, and look at the nearest neighbours of those players. Were they also nominees for the award?
      a. (Y/N) denotes whether or not they were nominated. 2017: closest were Ellie Blackburn (N), Elise O'Dea (N), Karen Paxman (Y), Emma Kearney (N), Daisy Pearce (Y), Dana Hooker (N), Lily Mithen (N), Brianna Davey (Y). 
      b. 2018: closest were Alicia Eva, Dana Hooker, Elise O'Dea, Ebony Marinoff, Daisy Pearce, Alexandra Anderson, Karne Paxman. (Shortlist for this year could not be found, though was assumed to be similar to previous year.)
